...
update-alternatives --install /usr/bin/java java ~/tools/jdk1.8.0_112/bin/java 100
update-alternatives --install /usr/bin/javac java ~/tools/jdk1.8.0_112/bin/javac 100
java -version
